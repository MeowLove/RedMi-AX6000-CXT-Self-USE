...
# 修改 主机名
sed -i 's/OpenWrt/CXT-FireWall/g' package/base-files/files/bin/config_generate
...
# 修改 WIFI SSID 
sed -i 's/OpenWrt/CXT-WLAN-HIDE/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
